            ...
            <div className="flex gap-[40px]">
                <div
                    ...
                    <div className="flex gap-[20px]">
                        <Image
                            src={currentBook?.image || "/BookImage/image1.svg"}
                            alt="book Image"
                            width={192}
                            height={272}
                            className="w-[192px] h-[272px] rounded-[5px] object-cover"/>
                        <div className="w-full flex flex-col gap-[20px]">
                            ...
                            <div className="w-[292px] h-[30px] flex items-center">
                                <Image src="/cash-outline 1.svg" alt="pul svg" width={28} height={28}
                            ...
                            <div className="w-[748px] h-[62px] flex">
                                <div
                                    ...
                                    <div className="w-[88px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/Union.svg" alt="daraja icon" width={14} height={14}
                                ...
                                <div
                                    ...
                                    <div className="w-[106px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/author.svg" alt="muallif icon" width={14} height={14}
                                                   className="w-[14px] h-[14px]"/>
                                ...
                                <div
                                    ...
                                    <div className="w-[97px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/sahifaIcon.svg" alt="sahifa icon" width={14} height={14}
                                                   className="w-[14px] h-[14px]"/>
                                ...
                                <div
                                    ...
                                    <div className="w-[150px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/kalendar.svg" alt="kalendar icon" width={14} height={14}
                                                   className="w-[14px] h-[14px]"/>
